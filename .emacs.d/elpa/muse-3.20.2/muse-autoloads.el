...

;;;### (autoloads nil "cgi" "cgi.el" (0 0 0 0))
;;; Generated autoloads from cgi.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cgi" '("cgi-")))

;;;***

;;;### (autoloads nil "httpd" "httpd.el" (0 0 0 0))
;;; Generated autoloads from httpd.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "httpd" '("defhttpd-exception" "httpd-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "muse-http" '("httpd-var" "muse-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "muse-mode" '("muse-" "turn-o")))
...
;;;***

;;;### (autoloads nil nil ("htmlize-hack.el" "muse-pkg.el") (0 0
;;;;;;  0 0))
