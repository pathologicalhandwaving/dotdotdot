...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-ext-ff" '("helm-ext-f")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-ext-minibuffer" '("helm-ext--use-header-line-maybe")))
