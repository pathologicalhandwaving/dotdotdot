...
(setq org-refile-targets '((mega-dictionary-default-file :maxlevel . 3)
                           (exile-notes-file :maxlevel . 3)
                           (exile-inbox :maxlevel . 3)
                           (library-annex-readlater-file :maxlevel . 3)
                           (library-annex-quotes-file :maxlevel . 4)
                           (monopoly-payments-file :maxlevel . 3)
